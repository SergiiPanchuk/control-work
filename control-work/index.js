...
class renderUsers {
    static async showAll() {
        try {
            ...
            const usersWrap = document.getElementsByClassName('users_wrap')[0];
            users.forEach(element => {
                ...
                linkDetails.classList.add('link_details');
                linkDetails.innerText = 'details';
                linkDetails.setAttribute('href', `user-details.html?id=${element['id']}`)


                userBlock.innerText = element['id'] + ') ' + element['name'];
