const arrTenElements: (number | string | boolean | object)[] = [25, true, "ivan", "vasia", 25.5, 100500, false, 3.14, 'petia', ['ivanka', "ilona", "inessa"]];
...
let day:number = +prompt('введіть число від 1 до 31');
if (day < 11 && day > 0) {
...
let dayOfWeek:number = +prompt('введіть число від 1 до 7, де 1 це понеділок а 7 неділя');
switch (dayOfWeek) {
    case 1:
        console.log('monday')
        break;
