...
var areaCircle = function (r) { return (Math.PI * Math.pow(r, 2)); };
console.log(areaCircle(4));
// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
var areaCylinder = function (h, rad) { return 2 * Math.PI * rad * (h + rad); };
console.log(areaCylinder(3, 5));
// - створити функцію яка приймає масив та виводить кожен його елемент
var returnElementOfArr = function (array) {
...
var createP = function (text) { return document.write("<p>".concat(text, "</p>")); };
createP('hello world');
...
var createListSecond = function (text, number) {
    document.write("<ul>");
...
var createListOfArr = function (arr) {
    document.write("<ul>");
...
var returnProperti = function (arr) {
...
var returnMinNumber = function (arr) {
    var minNumber = arr[0];
...
var swap2 = function (arr, index1, index2) {
    var newArr2 = [];
    for (var i = 0; i < arr.length; i++) {
        if (i === index1) {
