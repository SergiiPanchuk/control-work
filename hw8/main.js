...
// - Є масив:
const arrLi = ['Main','Products','About us','Contacts']
...
for (const arrayElement of coursesAndDurationArray) {
    ...
    divArr.innerText = (`title - ${arrayElement['title']}, monthDuration - ${arrayElement['monthDuration']}`);
...
for (const arrayElement of coursesAndDurationArray) {
    let divArr = document.createElement('div');
    divArr.classList.add('item');
    divArr.innerHTML =` <h1 class="heading">${arrayElement['title']}</h1> <p class='description'>${arrayElement['monthDuration']}</p>`;
    document.body.appendChild(divArr);
}
...
for (const arrayElement of simpsons) {
    let divArr = document.createElement('div');
    divArr.classList.add('member');
    divArr.innerHTML =`<p xmlns="http://www.w3.org/1999/html">name - ${arrayElement['name']},surname - ${arrayElement['surname']},age - ${arrayElement['age']},info - ${arrayElement['info']}, <img src="${arrayElement['photo']}" alt="photo"></p>`;
    document.body.appendChild(divArr);
}
...
for (const arrayElement of coursesArray) {
    ...
    divModules.style.border = 'solid 1px black';
}
